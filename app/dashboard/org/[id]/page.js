...
<div className="flex items-center justify-between px-6 py-0" style={{backgroundColor: 'white', borderBottom: '1px solid rgba(0,0,0,0.08)', height: '56px'}}>
  ...
  <div className="flex items-center gap-3">
    <button onClick={() => window.location.href = '/dashboard'} className="text-xs font-semibold px-3 py-1.5 rounded-lg transition-opacity hover:opacity-80" style={{backgroundColor: '#F3F4F6', color: '#0D2035', border: 'none'}}>← Back to Dashboard</button>
